...
Updated to run variable parameter testing Dropout, Look Back nodes, 
Batch samples, and Prediction Horizon by holding all constant and varying one.
7 Oct 2017
'''
import numpy as np
...
b=['Dropout', 'Look Back nodes', 'Batch samples', 'Prediction Horizon']
...
for i in range (len(b)-1):
    ...
    elif run_col == 1: #Look back nodes
        var_start = 2
        var_end = 72   #2*lead_time
        var_interval = 8
    
    elif run_col == 2: #Batch samples
        var_start = 2
        var_end = 100
        var_interval = 10
